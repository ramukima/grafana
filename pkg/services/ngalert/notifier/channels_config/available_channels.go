			...
			Options: []NotifierOption{
				{
					...
					Description:  "Cisco Webex API URL. Please enter the absolute URL.",
					PropertyName: "url",
					Required:     true,
				},
				{
					Label:        "Cisco Webex Team Room ID",
					Element:      ElementTypeInput,
					InputType:    InputTypeText,
					Placeholder:  "webex-room-id",
					Description:  "Webex Team Room Id that should receive the alerts.",
				...
				},
				{
					...
					Element:      ElementTypeInput,
					InputType:    InputTypeText,
					Description:  "Your Cisco Webex API secret.",
					PropertyName: "api_secret",
					Required:     true,
					Secure:       true,
				},
